...
public class StorageInterface {
    ...
    /**
     * Takes in an AllTaskLists of the current working tasks. This method returns true if all tasks are written into the Main Task File, false otherwise.
     * 
     * @param allTaskLists takes in an AllTaskLists of working tasks.
     * @return isSaved returns true if all tasks are written into the Main Task File, false otherwise. 
     */
    ...
    /**
     * Takes in main and floating ArrayLists of the current working tasks. This method returns true if all tasks are written into the Main Task File, false otherwise.
     * 
    ...
    /**
     * Checks if the queue size of the command queue is more than or equals to the constant QUEUE_SIZE and if the UI is in Search View. This method returns true if both conditions are met, and false otherwise.
     * 
     ...
     * 
     * @return commandsQueue returns a Queue of previously input commands up to a constant QUEUE_SIZE of 20.
     */
    ...
    /**
     * Takes in a new command queue and replaces the existing command queue with the new queue.
     * 
    ...
    /**
     * Clears the Command File when the changes are committed to the Main Task File.
     */
    ...
    /**
     * Takes in a file path for the new saving location of the Main Task File. This method returns a ResultSet to indicate the success or failure of changing the directory. -1 will be returned if an existing file is found. If the changing of directory is successful, the new directory will be saved to the Configuration File.
     * 
     * @param newFilePath
     * @return resultSet 
     */
    ...
    /**
     * Loads user's tasks from the specified file path. This method returns true if a file is found, false otherwise. It also updates the Configuration File with the new directory of the Main Task File.
     * 
     * @param newFilePath
     * @return isFileExists 
     */
    ...
    /**
     * Writes the chosen theme preference into the Configuration File. Returns true if the changes are successfully updated into the Configuration File, false otherwise.
     * 
     * @param themeName
     * @return isWritten returns true if the changes are written into the Configuration File, false otherwise.
     */
    ...
    /**
     * Returns the name of the preferred theme, previously read from the Configuration File.
     * 
